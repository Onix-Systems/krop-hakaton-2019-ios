...
//    
//    static let serviceDetailsModels = [ServiceDetailsModel(serviceTypeName: "УЗД", serviceDetailsName: "черевної порожнини", serviceName: "Ультразвукове дослідження сечо-статевої системи"), ServiceDetailsModel(serviceTypeName: "УЗД", serviceDetailsName: "нирок", serviceName: "Ультразвукове дослідження сечо-статевої системи"), ServiceDetailsModel(serviceTypeName: "УЗД", serviceDetailsName: "щитовидної залози", serviceName: "Ультразвукове дослідження сечо-статевої системи"), ServiceDetailsModel(serviceTypeName: "", serviceDetailsName: "Ехокардіографія", serviceName: "Ультразвукове дослідження сечо-статевої системи"), ServiceDetailsModel(serviceTypeName: "", serviceDetailsName: "Нейросонографiя", serviceName: "Ультразвукове дослідження сечо-статевої системи"), ServiceDetailsModel(serviceTypeName: "УЗД", serviceDetailsName: "сечо-статевої системи", serviceName: "Ультразвукове дослідження сечо-статевої системи")]
//    
