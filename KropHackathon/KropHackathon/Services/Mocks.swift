...
class Mock {
    ...
    static let serviceDetailsModels = [ServiceDetailsModel(serviceTypeName: "УЗД", serviceDetailsName: "черевної порожнини", serviceName: "УЗД сечо-статевої системи"), ServiceDetailsModel(serviceTypeName: "УЗД", serviceDetailsName: "нирок", serviceName: "УЗД сечо-статевої системи"), ServiceDetailsModel(serviceTypeName: "УЗД", serviceDetailsName: "щитовидної залози", serviceName: "УЗД сечо-статевої системи"), ServiceDetailsModel(serviceTypeName: "", serviceDetailsName: "Ехокардіографія", serviceName: "УЗД сечо-статевої системи"), ServiceDetailsModel(serviceTypeName: "", serviceDetailsName: "Нейросонографiя", serviceName: "УЗД сечо-статевої системи"), ServiceDetailsModel(serviceTypeName: "УЗД", serviceDetailsName: "сечо-статевої системи", serviceName: "УЗД сечо-статевої системи")]
